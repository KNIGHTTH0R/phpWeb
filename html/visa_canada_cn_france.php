...
<body>
    ...
    <!--france-->
    <div class="container">
        <p><br><a href="index.php">主页</a> >> <a href="visa_canada_cn.php">签证申请(加拿大境内)</a> >> 法国</p>
        <table>
            <tr>
                <td id="content_bg">
                    <div id="content">
                        <div id="content">
                            ...
                            <div id="visa_canada_detail_cn">
                                <h2 style="margin-bottom: 20px; color: red;">法国签证</h2>

                                <div style="line-height: 180%;" id="visa_detail">
                                    <p><b>特别说明：</b><br/> 法国短期申根签证（France Short-Stay Schengen Visa）是指在欧盟国境内逗留0~90天。<br/>已经入加拿大籍的不需要申根签证，因为加拿大居民享有去法国免签的特权。拿到枫叶卡但还未入籍的以及留学生必须去签一个申根，拿到法国短期签证后才有资格进入欧盟国家。</p>

                                    <p><b>签证时间：</b><br/> 建议提前2~3个月去预约法国面签<br/>签证办理时间为3-7个工作日，建议提前一个月申请。</p>
