...
<body>
    ...
    <!--turky-->
    <div class="container">
        <p><br><a href="index.php">主页</a> >> <a href="visa_canada_cn.php">签证申请(加拿大境内)</a> >> 土耳其</p>
        <table>
            <tr>
                <td id="content_bg">
                    <div id="content">
                        <div id="content">
                            ...
                            <div id="visa_canada_detail_cn">
                                <h2 style="margin-bottom: 20px; color: red;">土耳其签证</h2>

                                <div style="line-height: 180%;" id="visa_detail">
                                    <p><b>特别说明：</b><br/> 加拿大户籍，枫叶卡未入籍以及中国护照留学生，工签持有者需要申请签证。<br/>土耳其停留不超过7天，可以办理过境签。</p>

                                    <p><b>签证时间：</b><br/> 土耳其签证所需时间为3-5个工作日。</p>
