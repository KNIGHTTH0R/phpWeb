...
<body>
    ...
    <!--spanish-->
    <div class="container">
        <p><br><a href="index.php">主页</a> >> <a href="visa_canada_cn.php">签证申请(加拿大境内)</a> >> 西班牙</p>
        <table>
            <tr>
                <td id="content_bg">
                    <div id="content">
                        <div id="content">
                            ...
                            <div id="visa_canada_detail_cn">
                                <h2 style="margin-bottom: 20px; color: red;">西班牙签证</h2>

                                <div style="line-height: 180%;" id="visa_detail">
                                    <p><b>特别说明：</b><br/> 已入加拿大籍可以获得面签90天，但是枫叶卡以及留学生需要申请申根签证。<br/>最新更新 ：西班牙申请签证现需要预约才能递签。</p>

                                    <p><b>签证时间：</b><br/> 签证下来时间为一般为7-20个工作日。</p>
