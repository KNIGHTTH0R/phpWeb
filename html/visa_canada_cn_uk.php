...
<body>
    ...
    <!--uk-->
    <div class="container">
        <p><br><a href="index.php">主页</a> >> <a href="visa_canada_cn.php">签证申请(加拿大境内)</a> >> 英国</p>
        <table>
            <tr>
                <td id="content_bg">
                    <div id="content">
                        <div id="content">
                            ...
                            <div id="visa_canada_detail_cn">
                                <h2 style="margin-bottom: 20px; color: red;">英国签证</h2>

                                <div style="line-height: 180%;" id="visa_detail">
                                    <p><b>特别说明：</b><br/> 英国签证需要面签，加拿大受理点，分别在：渥太华，多伦多，温哥华，埃德蒙顿，哈利法克斯和圣约翰。</p>

                                    <p><b>签证时间：</b><br/> 签证办理时间为15-20个工作日，建议提前一个月申请。</p>
