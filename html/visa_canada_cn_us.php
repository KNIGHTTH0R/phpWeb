...
<body>
    ...
    <!--us-->
    <div class="container">
        <p><br><a href="index.php">主页</a> >> <a href="visa_canada_cn.php">签证申请(加拿大境内)</a> >> 美国</p>
        <table>
            <tr>
                <td id="content_bg">
                    <div id="content">
                        <div id="content">
                            ...
                            <div id="visa_canada_detail_cn">
                                <h2 style="margin-bottom: 20px; color: red;">美国签证</h2>

                                <div style="line-height: 180%;" id="visa_detail">
                                    <p><b>签证时间：</b><br/> 美国签证下来时间一般为7—15个工作日，确切时间可以凭借免签结束后收到的一个tracking number来确定。面签是否通过，当场就可以得知。</p>
                                    ...
                                    <ul>
                                        ...
                                        <li>关于其他
                                            <ul>
                                                ...
                                                <li>近三个月的信用卡记录（最好有）</li>
                                                <li>资金证明（last 3 months bank statement）建议CAD5000及以上</li>
                                                <li>在美国联系人姓名，住址，电话及邮箱</li>
                                            </ul>
                                        </li>
                                        <li>关于照片
                                            <ul>
                                    ...
                                    <p><b>面签所需材料：</b><br/> 面谈当天必须携带护照原件、护照复印件、照片原件、DS160确认页、预约信，以及其他（如支持性文件不能提供，不会影响您的送签，但如果领馆抽查时您无法提供，则可能会影响您的签证结果）按时前往领馆进行面谈。<br/>备注：<br/>1. 请不要折叠、涂改打印出来的DS-160确认页；<br/>2.面谈当天请按时到达领馆并按照领馆要求排队（具体情况以领馆当天要求为准，具体请咨询领馆工作人员，我司不设面试陪同人员）</p>
                                    
                                    
                                    <p><b>注意事项：</b><br/> 1. 您所提交的表格信息申请人必须诚实、认真、仔细填写。如果表格填写不实、漏填、字迹不清楚，可能会导致签证申请遭到拒绝，或延误旅行，由此产生的一切后果由申请人自行承担。我们并不负责核查您的信息，请务必注意填写您的停留时间等个人信息，确保信息没有错误以及遗漏。如果因为信息不全等原因造成的延误或拒签，本公司概不负责；在办理签证期间，我司可能会根据您的材料情况要求增补其他材料、或予以劝退；领馆也可能会针对您的实际情况，要求增补其他材料，或延长签证受理时间（此情况由领馆决定，我司无法干预）。领馆也可能因内部原因导致延迟出签，本公司相关的受理时间信息仅供参考，非法定承诺。<br/> 2. 大使馆办理签证所需工作日是指您的护照进入大使馆受签开始计算的时间，没有包括快递和中途可能滞留的时间，建议您尽量提前办理签证以免耽误出行；签证资料上公布的签证有效期和停留天数，仅做参考而非任何法定承诺，一切均以签证官签发的签证内容为唯一依据。请根据签证所在国里的签证有效期限内选择出行日期。<br/> 3. 我们将为您预约签证面试时间，如您对面试时间有要求请提前告知，在领馆有相应名额开放的情况下，我们将尽量满足您的要求,但具体预约时间仍以领馆为准，一旦成功预约，不可以更改或取消，必须参加面试；如果需要代选指定日期，需要额外收费（______签证指定服务额外费用为CAD_________）, 本公司应相关的受理要求代办非法定承诺，如果无法选中指定日期，不退回额外服务费用。<br/> 4. 在您获得签证前请勿先行支付机票、酒店费用，以免因签证问题产生费用损失，否则损失将由您自行承担；如您提供了机票、酒店预订单申请签证，请勿在获得签证前取消预订，否则可能对签证结果产生影响。<br/>5. 申请费费用无论签证是否成功，不可退还（_________签证代办费用为CAD_________）；如果指定本公司负责代发以及代收以及转发相关文件，申请材料，本公司办公时间为周一到周五早10点到下午6点。来之前请务必致电我们确认您的信息，并约定取证时间。您可以自己提供预付回邮信封，我们将使用您提供的信封寄回您的护照，不收取回邮费用。我们使用FedEx或等级邮寄公司寄回您的护照，任何邮寄过程中的延误或丢失与本公司无关，请参考邮寄公司的规章制度与其交涉。 <br/>6. 不接收6个月内有美国拒签记录的护照。</p>
                                </div>
