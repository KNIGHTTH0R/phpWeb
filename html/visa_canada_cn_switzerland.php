...
<body>
    ...
    <!--switzerland-->
    <div class="container">
        <p><br><a href="index.php">主页</a> >> <a href="visa_canada_cn.php">签证申请(加拿大境内)</a> >> 瑞士</p>
        <table>
            <tr>
                <td id="content_bg">
                    <div id="content">
                        <div id="content">
                            ...
                            <div id="visa_canada_detail_cn">
                                <h2 style="margin-bottom: 20px; color: red;">瑞士签证</h2>

                                <div style="line-height: 180%;" id="visa_detail">
                                    <p><b>特别说明：</b><br/> 已入加拿大籍可以获得面签90天，但是枫叶卡以及留学生需要申请申根签证。<br/>BC、AB、SK、YT和NT省需要在温哥华Vancouver面签。<br/>QC、MB、NB、NL、NS、ON、PE、NU和Bahamas需要在蒙特利尔Montreal面签。</p>

                                    <p><b>签证时间：</b><br/> 签证下来时间为一般为10-15个工作日，提前3个月预约，请合理安排时间。</p>
                                    ...
                                    <ul>
                                        ...
                                        <li>关于其他
                                            <ul>
                                                ...
                                                <li>银行存款证明（CAD8000以上），以及过去三个月银行记录</li>
