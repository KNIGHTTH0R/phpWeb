...
<body>
    ...
    <!--brazil-->
    <div class="container">
        <p><br><a href="index.php">主页</a> >> <a href="visa_canada_cn.php">签证申请(加拿大境内)</a> >> 巴西</p>
        <table>
            <tr>
                <td id="content_bg">
                    <div id="content">
                        <div id="content">
                            ...
                            <div id="visa_canada_detail_cn">
                                <h2 style="margin-bottom: 20px; color: red;">巴西签证</h2>

                                <div style="line-height: 180%;" id="visa_detail">
                                    <p><b>签证时间：</b><br/> 签证下来时间为一般为7-15个工作日。 请提前安排时间，以免耽误您的行程。</p>
                                    ...
                                    <ul>
                                        ...
                                        <li>关于其他
                                            <ul>
                                                ...
                                                <li>一张交签证费的MONEY ORDER（25加币）, 收款人为：CONSULATE GENERAL OF BRAZIL </li>
                                                <li>如果是邮递申请的话，还要附上一个付过费的CANADA POST的回邮信封，（必须是CANADAPOST的）</li>
                                                <li>一份巴西旅游行程，越详细越好</li>
                                            </ul>
                                        </li>
                                        <li>关于照片
                                            <ul>
