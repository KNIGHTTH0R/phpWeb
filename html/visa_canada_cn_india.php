...
<body>
    ...
    <!--india-->
    <div class="container">
        <p><br><a href="index.php">主页</a> >> <a href="visa_canada_cn.php">签证申请(加拿大境内)</a> >> 印度</p>
        <table>
            <tr>
                <td id="content_bg">
                    <div id="content">
                        <div id="content">
                            ...
                            <div id="visa_canada_detail_cn">
                                <h2 style="margin-bottom: 20px; color: red;">印度签证</h2>

                                <div id="visa_detail">
                                    <p><b>特别说明：</b><br/> 印度签证加拿大受理点为渥太华、多伦多、温哥华。加拿大籍也需要申请旅游签证。</p>
                                    ...
                                    <p>签证时间可能有变动，取决于印度签证受理中心。快递时间5-10个工作日。</p>
